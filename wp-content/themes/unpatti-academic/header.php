    ...
    <div class="header-top">
        <div class="container">
            <div class="header-top-inner">
                <span class="header-top-text"><?php echo esc_html( get_theme_mod( 'unpatti_address', '' ) ); ?></span>
                <div class="header-top-right">
                    <?php if ( $phone = get_theme_mod( 'unpatti_phone' ) ) : ?>
                    ...
                    <?php endif; ?>
                    <?php if ( $email = get_theme_mod( 'unpatti_email' ) ) : ?>
            ...
            <div class="header-main-inner">
                <div class="site-branding">
                    ...
                    <div class="site-branding-text">
                        <h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html( unpatti_get_institution_name() ); ?></a></h1>
                        <p class="site-description"><?php bloginfo( 'description' ); ?></p>
                    </div>
                </div>

                <button class="menu-toggle" aria-controls="primary-navigation" aria-expanded="false" aria-label="<?php esc_attr_e( 'Menu', 'unpatti-academic' ); ?>">
                    <span class="hamburger"></span>
                </button>

                <nav id="primary-navigation" class="main-navigation" aria-label="<?php esc_attr_e( 'Menu Utama', 'unpatti-academic' ); ?>">
                    <?php
                    wp_nav_menu( [
