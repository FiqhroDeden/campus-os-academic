...
class UNPATTI_Partner_Logos extends \Elementor\Widget_Base {

    public function get_name() { return 'unpatti_partner_logos'; }
    public function get_title() { return __( 'Partner Logos', 'unpatti-academic' ); }
    public function get_icon() { return 'eicon-gallery-grid'; }
    public function get_categories() { return [ 'unpatti-academic' ]; }

    protected function register_controls() {
        $this->start_controls_section( 'content_section', [
            'label' => __( 'Partners', 'unpatti-academic' ),
        ...
        $repeater->add_control( 'logo', [
            'label'   => __( 'Logo', 'unpatti-academic' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'default' => [ 'url' => \Elementor\Utils::get_placeholder_image_src() ],
        ] );

        $repeater->add_control( 'name', [
            'label'   => __( 'Partner Name', 'unpatti-academic' ),
            'type'    => \Elementor\Controls_Manager::TEXT,
            'default' => __( 'Partner', 'unpatti-academic' ),
        ] );

        $repeater->add_control( 'link', [
            'label'       => __( 'Link', 'unpatti-academic' ),
    ...
    protected function render() {
        ...
        <div id="<?php echo esc_attr( $id ); ?>">
            ...
            ?>
                <div class="unpatti-partner-item">
                    <?php if ( $link_url ) : ?>
