...
<section class="homepage-section homepage-faq">
    <div class="container">
        <h2><?php esc_html_e( 'Pertanyaan Umum', 'unpatti-academic' ); ?></h2>
        <?php
        $items = new WP_Query( [
            'post_type'      => 'faq',
            'posts_per_page' => 10,
        ...
        <div class="faq-list" style="margin-top:1rem;">
            ...
            <details style="border:1px solid var(--unpatti-border, #e5e7eb);border-radius:4px;margin-bottom:0.5rem;padding:1rem;">
